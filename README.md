...
<h2>Description</h2>
For this project I completed an internal security audit, a review of the organization's security controls, policies, and procedures against a set of expectations.
<br />
